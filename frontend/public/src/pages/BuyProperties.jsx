...
/**
 * Pagina de listado "Comprar": panel izquierdo con buscador/filtros/grid
 * y mapa a la derecha con las mismas propiedades filtradas. Toda la logica
 * de datos (fetch, busqueda, filtro, orden) vive en usePropertyListing;
 * este componente solo se encarga de pintar el estado que el hook expone.
 */
const BuyProperties = () => {
    const {
        isLoading, filtered,
                ...
                <div className='w-full md:w-[480px] shrink-0 flex flex-col overflow-hidden'>
                    ...
                    <div className='px-5 pt-5 pb-3 flex flex-col gap-3'>
                        <div className='flex items-center justify-between'>
                            <h1 className='text-lg font-semibold text-orve-teal'>Propiedades en venta</h1>
