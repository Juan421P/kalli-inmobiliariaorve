    ...
    return (
        <div className='flex flex-col gap-3'>
            <div
                ...
                className={`border-2 border-dashed rounded-xl p-8 flex flex-col items-center gap-2 cursor-pointer transition-all select-none ${
                    dragging
                        ? 'border-orve-teal bg-orve-teal/10'
                        : 'border-orve-teal/20 bg-orve-teal/[0.02] hover:border-orve-teal/40 hover:bg-orve-teal/5'
                }`}
            >
                <ImagePlus className='w-8 h-8 text-orve-teal/40' />
                <p className='text-sm font-medium text-orve-teal/70'>
                ...
                <Field>
                    <FieldLabel>
                        ...
                        <Input
                            ...
                            placeholder='Ej. Colonia Las Flores, Calle Principal #12, San Salvador'
                            className='bg-white/70'
                        />
                    </FieldLabel>
