...
const RentOutPropertyScreen = () => (
    <View style={styles.flex}>
        <Text style={styles.title}>Puesta en renta de propiedad</Text>
        <Text style={styles.description}>
            Para poner su propiedad en alquiler, es necesario completar y firmar el Formulario de Arrendamiento.
        </Text>
...
export default RentOutPropertyScreen;
